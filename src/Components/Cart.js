                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src={tele} class="recent-thumb" alt=""/>
                        ...
                        <div class="thubmnail-recent">
                            <img src={celular}class="recent-thumb" alt=""/>
                        ...
                        <div class="thubmnail-recent">
                            <img src={play} class="recent-thumb" alt=""/>
                        ...
                        <div class="thubmnail-recent">
                        <img src={tele} alt="" class="recent-thumb"/>
                                    ...
                                    <tbody>
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src={celular}/></a>
                                            </td>
                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src={product2}/>
                                    ...
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src={product4}/>
                                            <h3>Ship Your Idea</h3>
                                            <span class="price"><span class="amount">£20.00</span></span>
                                        </a>
